...
def getMatchStats(url, id):
    ...
    stats.append(float(homeElems[3]))
    stats.append(float(homeElems[4]))
    stats.append(float(homeElems[6]))
    stats.append(float(homeElems[7]))
    stats.append(float(homeElems[9]))
    stats.append(float(homeElems[10]))
    stats.append(float(homeElems[11]))
    stats.append(float(homeElems[12]))
    stats.append(float(homeElems[14]))
    stats.append(float(homeElems[15]))
    stats.append(float(homeElems[16]))
    stats.append(float(homeElems[17]))
    stats.append(float(homeElems[18]))
    stats.append(float(awayElems[3]))
    stats.append(float(awayElems[4]))
    stats.append(float(awayElems[6]))
    stats.append(float(awayElems[7]))
    stats.append(float(awayElems[9]))
    stats.append(float(awayElems[10]))
    stats.append(float(awayElems[11]))
    stats.append(float(awayElems[12]))
    stats.append(float(awayElems[14]))
    stats.append(float(awayElems[15]))
    stats.append(float(awayElems[16]))
    stats.append(float(awayElems[17]))
    stats.append(float(awayElems[18]))
    # HUSTLE
    ...
    for elem in rows[0]:
        if (check_exists_by_tag(elem, "a")):
            ...
            awayElems.append(elem.get_attribute("innerHTML"))
    stats.append(float(homeElems[2]))
    stats.append(float(homeElems[3]))
    stats.append(float(homeElems[4]))
    stats.append(float(homeElems[5]))
    stats.append(float(homeElems[6]))
    stats.append(float(homeElems[9]))
    stats.append(float(homeElems[10]))
    stats.append(float(homeElems[12]))
    stats.append(float(homeElems[13]))
    stats.append(float(awayElems[2]))
    stats.append(float(awayElems[3]))
    stats.append(float(awayElems[4]))
    stats.append(float(awayElems[5]))
    stats.append(float(awayElems[6]))
    stats.append(float(awayElems[9]))
    stats.append(float(awayElems[10]))
    stats.append(float(awayElems[12]))
    stats.append(float(awayElems[13]))
    # print(stats)
    # while (1):
    #     continue
    driver.close()
